...
copy_text <- read_utf8("modules", "common", "stat_analysis_submodule_copy.R")
...
expect_contains(desc_text, "source\\(\"modules/common/stat_analysis_submodule_copy.R\"\\)", "desc 加载统计分析共享文案")
...
expect_contains(cox_text, "source\\(\"modules/common/stat_analysis_submodule_copy.R\"\\)", "cox 加载统计分析共享文案")
...
expect_contains(logistic_text, "source\\(\"modules/common/stat_analysis_submodule_copy.R\"\\)", "logistic 加载统计分析共享文案")
...
expect_contains(linear_text, "source\\(\"modules/common/stat_analysis_submodule_copy.R\"\\)", "linear 加载统计分析共享文案")
...
expect_contains(anova_text, "source\\(\"modules/common/stat_analysis_submodule_copy.R\"\\)", "anova 加载统计分析共享文案")
...
expect_contains(chisq_text, "source\\(\"modules/common/stat_analysis_submodule_copy.R\"\\)", "chisq 加载统计分析共享文案")
