...
copy_text <- read_utf8("modules", "common", "graphics_result_copy.R")
...
expect_contains(survival_text, "source\\(\"modules/common/graphics_result_copy.R\"\\)", "生存分析加载结果区共享文案")
...
expect_contains(forest_text, "source\\(\"modules/common/graphics_result_copy.R\"\\)", "森林图加载结果区共享文案")
...
expect_contains(combo_text, "source\\(\"modules/common/graphics_result_copy.R\"\\)", "组合图加载结果区共享文案")
...
expect_contains(waterfall_text, "source\\(\"modules/common/graphics_result_copy.R\"\\)", "瀑布图加载结果区共享文案")
...
expect_contains(swimmer_text, "source\\(\"modules/common/graphics_result_copy.R\"\\)", "泳道图加载结果区共享文案")
...
expect_contains(spider_text, "source\\(\"modules/common/graphics_result_copy.R\"\\)", "蜘蛛图加载结果区共享文案")
